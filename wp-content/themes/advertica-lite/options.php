...
//Home Page Featured Box Options	
	...
	//Featured Box 1
		$options[] = array(
			...
			'std' => 'TODO: Change Me...Business Strategy',
			'type' => 'text');
		...
		$options[] = array(
		 ...
		 $options[] = array(
				...
				'std' => ' TODO: Change Me...Get focused from your target consumers and increase your business with Web portal Design and Development. ',
				'type' => 'textarea');
		...
		$options[] = array(
			...
			'std' => 'TODO: Change Me...Quality Products',
			'type' => 'text');
	    ...
	    $options[] = array(
			...
			'std' => ' TODO: Change Me...Products with the ultimate features and functionality that provide the complete satisfaction to the clients.',
			'type' => 'textarea');
	...
	//Featured Box 3
		$options[] = array(
			...
			'std' => 'TODO: Change Me....Best Business Plans',
			'type' => 'text');
		...
		$options[] = array(
	 	...
	 	$options[] = array(
			...
			'std' => ' TODO: Change Me...Based on the client requirement, different business plans suits and fulfill your business and cost requirement.',
			'type' => 'textarea');
	...
	$options[] = array(
			...
			'std' => '<div class="skt-awesome-section"> 
						<div class="skt-awesome-title">TODO: Change Me....Awesome Parallax Section</div><div class="skt-awesome-desp">TODO: Change Me...Advertica features an amazing parallax section</div>
					  </div>',
			'type' => 'textarea');
